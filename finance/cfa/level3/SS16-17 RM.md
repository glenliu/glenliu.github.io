...
- βs and durations not reflect the acutal subsequent market value changes;
...
-  iii) the effective number of shares in the index converted to cash, and
-  iv) assuming the index closes at 1,057, demonstrate the strategy is equivalent to having invested at the risk-free rate.
...
50,000,000(1.009^5/12) / (1,135)(500) = 50,187,010 / 567,500 = 88.44 ≈ 88 

ii. The effective initial amount of cash equivalents is:

[88($500)(1,135)] / 1.009^5/12 = $49,940,000 / 1.0037402 = $49,753,910

iii. The effective number of shares converted to cash is:

88(500) / 1.017^5/12 = 44,000 / 1.0070485 = 43,692.04

With dividends reinvested, this is ending shares of:

43,692.04(1.017^5/12) = 44,000
...
- Adjustments are often stated as percent allocations; however, the calculations require dollar or other nominal amounts (e.g., a 10% shift of a EUR 50M portfolios a EUR 5M Vp).
...
- Transaction exposure is the type of exchange rate risk that refers to a need to exchange one currency for another at a future date and uncertainty regarding what the exchange rate will be at that time.
- Translation exposure is the type of exchange rate risk that refers to changes in exchange rates that have to be reflected on ***accounting*** statements and reduce a firm’s book value of equity or accounting income.
- Economic exposure is the type of exchange rate risk that refers to changes in exchange rates that make a business less price competitive in other countries.
...
Effective dollar interest cost = $10,000,000(LIBORApril 1 + 0.02)(90 / 360) − (call payoff)
...
EAR = [($10,000,000 + effective dollar interest cost) / ($9,994,972)]^(365/90) − 1

四个考试时要注意的事宜：
1. 如果是 lender 计算 effective interest rate，分母是所有的支出，包括：NP+long IRO put 的 FV(premium)
...
- Assume that the counterparty has a $20 million fixed-rate debt outstanding at 8%. One-year LIBOR is currently 7%. 
 ...
 ![IRS cash flow](images/IRS-1.PNG)
...
For the euros, the NP = €10,000,000 / (0.05 / 2) = €400,000,000. 

The corresponding dollar amount is €400,000,000 / 0.9 = $444,444,444. 

Using these values for the swap, the firm will give the swap dealer €10,000,000 every six months over the maturity of the swap for:
